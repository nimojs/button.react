...
/******/ 	__webpack_require__.p = "/button.react/0.3.0";
/******/
...
var ButtonLoose = function (_React$Component) {
    _inherits(ButtonLoose, _React$Component);

    function ButtonLoose() {
        _classCallCheck(this, ButtonLoose);

        return _possibleConstructorReturn(this, (ButtonLoose.__proto__ || Object.getPrototypeOf(ButtonLoose)).apply(this, arguments));
    }

    _createClass(ButtonLoose, [{
        key: 'render',
...
var ButtonLooseImport = function (_React$Component2) {
    _inherits(ButtonLooseImport, _React$Component2);

    function ButtonLooseImport() {
        _classCallCheck(this, ButtonLooseImport);

        return _possibleConstructorReturn(this, (ButtonLooseImport.__proto__ || Object.getPrototypeOf(ButtonLooseImport)).apply(this, arguments));
    }

    _createClass(ButtonLooseImport, [{
        key: 'render',
        value: function render() {
            var themes = this.props.themes;
            // 三次封装 light
            themes = themes + ' import';
            return __webpack_require__("./node_modules/react/index.js").createElement(ButtonLoose, _extends({}, this.props, { themes: themes }));
        }
    }]);

    return ButtonLooseImport;
}(React.Component);
